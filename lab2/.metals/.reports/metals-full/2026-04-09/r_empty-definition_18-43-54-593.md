error id: file://<WORKSPACE>/backend/src/main/scala/solver/library/Library.scala:sys26.
file://<WORKSPACE>/backend/src/main/scala/solver/library/Library.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -solver/library/systems/Systems.sys26.
	 -solver/library/systems/Systems.sys26#
	 -solver/library/systems/Systems.sys26().
	 -Systems.sys26.
	 -Systems.sys26#
	 -Systems.sys26().
	 -scala/Predef.Systems.sys26.
	 -scala/Predef.Systems.sys26#
	 -scala/Predef.Systems.sys26().
offset: 1892
uri: file://<WORKSPACE>/backend/src/main/scala/solver/library/Library.scala
text:
```scala
