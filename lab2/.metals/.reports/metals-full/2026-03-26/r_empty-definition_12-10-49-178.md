error id: file://<WORKSPACE>/backend/src/main/scala/solver/methods/SimpleIteration.scala:FunctionPack#
...
class SimpleIteration extends Method1D {
  override def solve(pack: Functi@@onPack, a: Double, b: Double, eps: Double): Double = {
