error id: file://<WORKSPACE>/backend/src/main/scala/routes/SolverRoutes.scala:DefaultJsonProtocol.
file://<WORKSPACE>/backend/src/main/scala/routes/SolverRoutes.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -akka/http/scaladsl/server/Directives.spray.json.DefaultJsonProtocol.
	 -models/spray/json/DefaultJsonProtocol.
	 -spray/json/DefaultJsonProtocol.spray.json.DefaultJsonProtocol.
	 -Samples.spray.json.DefaultJsonProtocol.
	 -spray/json/DefaultJsonProtocol.
	 -scala/Predef.spray.json.DefaultJsonProtocol.
offset: 220
...
import models._
import spray.json.DefaultJso@@nProtocol._
import Samples._
