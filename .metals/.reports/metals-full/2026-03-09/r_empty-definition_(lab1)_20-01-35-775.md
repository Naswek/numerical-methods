...
class MatrixSolver {
    ...
    def makeDiagonallyDominant(matrix: Array[Array[Double]]): Boolean =
        ...
        colorPrinter.printError("не удалось добиться диагонального преобладания")
        false
    ...
    def toJacobiForm(matrix: Array[Array[Double]]): (Array[Array[Double]], Array[Double]) = {
        ...
        colorPrinter.printSuccess("Получившаяся матрица C:")
    ...
    def requestInitialApproximation(dimension: Integer): Array[Double] =
            colorPrinter.prin(f"Напишите начальное приближение c размерностью {dimension}, формат ввода: x1 x2 x3 ... xn")
}
